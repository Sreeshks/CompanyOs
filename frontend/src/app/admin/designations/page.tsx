...
// ============================================================
// Company OS — Designations Master Data
// ============================================================
...
export default function DesignationsPage() {
  ...
  const createMutation = useMutation({
    mutationFn: (data: { name: string; code: string }) => masterDataApi.createDesignation(data),
    onSuccess: () => {
    ...
    <div className="p-6 space-y-6 max-w-5xl mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm mt-1" style={{ color: 'var(--muted-foreground)' }}>
            Define job titles, professional roles, and internal hierarchy levels
          </p>
        </div>
      ...
      {isLoading ? (
        ...
        <EmptyState
          ...
          description="Create job designations to map employee roles."
          ...
          <table className="w-full text-left text-sm">
            <thead>
              <tr className="border-b text-xs uppercase" style={{ borderColor: 'var(--border)', color: 'var(--muted-foreground)' }}>
                <th className="px-6 py-3 font-semibold">Designation Title</th>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4">
          ...
          >
            ...
            <div className="flex items-center justify-end gap-3 pt-4 border-t" style={{ borderColor: 'var(--border)' }}>
              ...
              >
                {createMutation.isPending ? 'Creating...' : 'Save Designation'}
              </button>
            </div>
          </div>
        </div>
